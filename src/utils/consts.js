export const ADMIN_MAIN_PAGE_ROUTE = '/admin/1'
export const ADMIN_SECOND_PAGE_ROUTE = '/admin/2'
export const ADMIN_VACANCIES_ROUTE = '/admin/3'
export const ADMIN_THIRD_PAGE_ROUTE = '/admin/4'
export const ADMIN_FOURTH_PAGE_ROUTE = '/admin/5'
